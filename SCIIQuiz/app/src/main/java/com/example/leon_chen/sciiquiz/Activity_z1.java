...
public class Activity_z1 extends Activity{
        ...
        l_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(progressBar.getProgress() == 25){
                    ...
                    intent.setClass(Activity_z1.this, Activity_2.class);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mButtonChoice1.getText() == mAnswer) {
                    ...
                    Toast.makeText(Activity_z1.this, "correct", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(Activity_z1.this, "wrong", Toast.LENGTH_SHORT).show();
                }
                if (mQuestionNumber == 3) {
                    Intent intent = new Intent();
                    intent.setClass(Activity_z1.this, Activity_final.class);
                    startActivity(intent);
                }
                else
                    updateQuestion();
